...
ig.Entity = ig.Class.extend({
	...
	reset: function( x, y, settings ) {
		...
		this.angleVel = proto.angleVel;
		this.angleAcc = proto.angleAcc;
	...
	update: function() {
		...
		this.angleVel = this.getNewAngleVelocity( this.angleVel, this.angleAcc, this.angleFriction, this.maxAngleVel );
		...
		this.currentAnim.angle += this.angleVel * ig.system.tick;
	...
	getNewAngleVelocity: function( vel, accel, friction, max ) {
		if( accel ) {
			return ( vel + accel * ig.system.tick ).limit( -max, max );
		}
		else if( friction ) {
	...
	changeAnim: function( anim ) {
		var currentAngle = this.currentAnim.angle;
		this.currentAnim = anim;
		this.currentAnim.angle = currentAngle;
	},
